...
{
    public class LowPassFilterOperationViewModel : FourierFilterViewModel
    {
        #region Properties
        ...
        public LowPassFilterOperationViewModel(WorkspaceViewModel workspaceViewModel) : base(workspaceViewModel)
        {
        }
